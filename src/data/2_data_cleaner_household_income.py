...
relative_path = 'raw/household_income.csv'
...
with open(file_path, encoding="utf-8-sig") as bigdata:
    for line in bigdata:
        ...
        data_point[0] = pd.to_datetime("1/1/" + data_point[0][0:4])
...
relative_path = 'data_plotter2.csv'
file_path = os.path.join(dir_name, relative_path)
new_file = open(file_path, 'w')
old_file = open(os.path.join(dir_name, 'data_plotter.csv'))
